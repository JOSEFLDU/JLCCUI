...
<!-- ############ LAYOUT START-->
  <div class="center-block w-xxl w-auto-xs p-y-md">
    ...
    <div class="p-a-md box-color r box-shadow-z1 text-color m-a">
      ...
      <form name="form" method="post" target="registro.php">
        <div class="md-form-group">
          <input type="text" name="tusuario" class="md-input" value="<?php echo $email;?>" required>
          <label>Tipo Usuario</label>
        </div>
        <div class="md-form-group">
          <input type="nombre" class="md-input" required>
          <label>Nombre</label>
        </div>
        <div class="md-form-group">
          <input type="apellido" class="md-input" required>
        ...
        <div class="md-form-group">
          <input type="telefono" class="md-input" required>
